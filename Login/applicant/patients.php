...
<body onload="myFunction()" style="margin:0;">
    <div class="container">
       <div>
            <h3><center><u>PATIENTS</u></center></h3>
        ...
        <table id="example" class="display nowrap" cellspacing="0" width="100%">
            ...
            <tbody>
               ...
               session_start();
               $b = $_SESSION['a_id'];
               $sql = "SELECT * FROM patients,checkup WHERE patients.p_aadhar=checkup.p_aadhar AND p_verify='1' AND a_aadhar='$b'";
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" class="form-control" id="item_description" name="item_description" value="<?php echo $item_category; ?>" placeholder="Gender" required readonly><br>
                                            </div>
                                         ...
                                         <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <input type="text" maxlength="10" minlength="10" pattern="^[0-9]+$" id="mob" title="Number only" class="form-control" id="item_description" name="p_mob" value="<?php echo $p_mob; ?>" placeholder="Mobile" required><br>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                             <?php if ($checked ==1) { ?>
                                            <label class="control-label col-sm-2" for="item_code">Next Checkup Date:</label>
                                            <div class="col-sm-4">
                                                <input type="text" readonly class="form-control" id="item_code" name="p_curr_hlth_cond" value="<?php echo $checkup_date; ?>" placeholder="Current Health Condition" required><br> 
                                            </div>
                                        <?php } ?>
                                            <label class="control-label col-sm-2" for="item_name">Patient Name:</label>
                                            <div class="col-sm-4">
                                    ...
                                    <div class="modal-footer">
                                        <a href="checkupdetails.php?aadhar=<?php echo $p_aadhar; ?>&&name=<?php echo $item_name; ?>&&checkup=<?php echo $checkup_date; ?> &&p_aadhar=<?php echo $p_aadhar; ?>">
          ...
          if(isset($_POST['update_item'])){
            $p_name = mysqli_real_escape_string($conn, $_POST['item_name']);
           ...
           $sql = "UPDATE patients SET p_name='$p_name' , p_age='$p_age' , p_address = '$p_address' , p_mob = '$p_mob' WHERE p_aadhar='$p_aadhar'";
            ...
            { ?>
               ...
               location.href="http://localhost/pcu/Login/applicant/patients.php"
           </script>
